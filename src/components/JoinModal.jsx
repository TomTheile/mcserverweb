          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="bg-gray-700 p-4 rounded-sm mb-6 w-full">
                <img className="w-full h-auto rounded-sm border-2 border-gray-600" alt={`Minecraft ${steps[step-1].title} screenshot`} src="https://images.unsplash.com/photo-1644547933978-a79c34d5192a" />
              </div>
            </motion.div>
          </AnimatePresence>
